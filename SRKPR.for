...
!			if(NTDEP.ge.1)READ(NIN,*) Kinf
			if(NTDEP.eq.1)READ(NIN,*)(Tstar(j,i),j=1,i-1)
...
!			write(NOUT,*)
 ...
 1	FORMAT(A15,F7.3,5x,F7.3,3x,F7.3,3x,F7.3)
 5	FORMAT(A15,F6.3)
 6	FORMAT(A15,20F10.5)
